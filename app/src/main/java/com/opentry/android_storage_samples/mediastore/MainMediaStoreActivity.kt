...
import com.opentry.android_storage_samples.databinding.ActivityMainMediaStoreBinding
 ...
 * a [GridLayoutManager].
 */
class MainMediaStoreActivity : AppCompatActivity() {

    private val viewModel: MainActivityViewModel by viewModels()
    private lateinit var binding: ActivityMainMediaStoreBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this, R.layout.activity_main_media_store)
    ...
    private inner class GalleryAdapter(val onClick: (MediaStoreImage) -> Unit) :
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ImageViewHolder {
            ...
            val view = layoutInflater.inflate(R.layout.gallery_layout_media_store, parent, false)
