 ...
 */
public class MainSharingShortcutsActivity extends Activity {

    // Domain authority for our app FileProvider
    private static final String FILE_PROVIDER_AUTHORITY =
            "com.opentry.android_storage_samples.fileprovider";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_sharing_shortcuts);
        mEditBody = findViewById(R.id.body);
        findViewById(R.id.share).setOnClickListener(mOnClickListener);

        SharingShortcutsManager mSharingShortcutsManager = new SharingShortcutsManager();
